...
public class C02_Alerts {
   ...
   static WebDriver driver;
    ...
    public void acceptAlert() {
        ...
        String actualMesaj=sonucYaziElementi.getText();
    ...
    public void sendKeysAlert() {
        ...
        //      OK butonuna tıklayın ve result mesajında isminizin görüntülendiğini doğrulayın.
        driver.findElement(By.xpath("//*[text()='Click for JS Prompt']")).click();
        driver.switchTo().alert().sendKeys("cigdem");
        driver.switchTo().alert().accept();
        WebElement sonucYazisiElementi= driver.findElement(By.xpath("//p[@id='result']"));
        String cikanIsim="cigdem";
        String beklenenIsim=sonucYazisiElementi.getText();
        Assert.assertTrue(cikanIsim.contains(beklenenIsim));
